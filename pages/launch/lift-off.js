...
export default function Home() {
  return (
    <main>
      ...
      <p>
        We'll be getting you into a project as quickly as possible. We operate
      ...
      <p>
        You'll also need to log your time (Harvest). Once we're out of lock down you
      ...
      <p>
        ...
        Guilds as well, which are great to get in to.
      </p>
